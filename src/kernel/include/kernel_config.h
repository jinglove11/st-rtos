...
// #define KERNEL_WATCHDOG_TIMEOUT (1000)
...
/* 看门狗配置 */
#define KERN_WATCHDOG_ENABLE      KERNEL_WATCHDOG
#define KERN_WATCHDOG_TIMEOUT     KERNEL_WATCHDOG_TIMEOUT
